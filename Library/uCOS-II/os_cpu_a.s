...
NVIC_PENDSV_PRI 	EQU     0xFFFF0000  ; 软件中断和系统节拍中断优先级
                                            ; (都为最低，0xff).
...
OSStartHighRdy
        ...
        MOV     R4, #0                 ; set value for new Process stack
                                       ; 0 for initial context switch call
        MSR     PSP, R4                ; setup the new Process stack value
        ...
        STR     R5, [R4]
                                       ...
                                       ;wlh: if interrupts Enabled, should never get here
...
;* 函数名称: OSPendSV
;*
;* 功能描述: OSPendSV is used to make a context-switch.
;*
;* 参    数: None
;*
;* 返 回 值: None
...
OSPendSV
        ...
        CBZ     R0, OSPendSV_nosave     ; skip register save the first time
                                        ...
                                        ; IN exception:R0-R3,R12,R14,xPSR Hardware-Auto stacked
